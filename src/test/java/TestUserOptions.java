...
public class TestUserOptions {
  ...
  public void checkingRadioButton() throws InterruptedException {
    ...
    goToProfile();
    if (!driver.findElement(enableKeyboard).isSelected()) {
      logInPage.clickOnPage(driver, enableKeyboard);
    }
    ...
    if (!driver.findElement(radioButton).isSelected()) {
      logInPage.clickOnPage(driver, radioButton);
    }
  ...
  public java.util.List<WebElement> listTags() {
  ...
  public String randomName() {
    int randomIntName = nextInt(100, 999);
